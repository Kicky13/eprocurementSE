      ...
      <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">ED to be Revision</li>
          </ol>
        </div>
      </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <table id="tbl" class="table table-striped table-bordered table-fixed-column order-column dataex-lr-fixedcolumns table-hover table-no-wrap display" width="100%">
                          ...
                          <tbody>
                            <?php
                              $no=1;
                              foreach ($greetings['revisionbled']->result() as $msr) :
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <a href="<?=base_url('approval/approval/devbled/'.$msr->data_id.'/'.$msr->approval_id)?>" class="btn btn-sm btn-info">Process</a>
                              </td>
                            </tr>
                            <?php endforeach;?>
                          </tbody>
