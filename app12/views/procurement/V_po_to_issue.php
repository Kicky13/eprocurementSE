...
<div class="content-wrapper">
  <div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-1">
      <h3 class="content-header-title"><?= lang("Agreement Issuance", "Agreement Issuance") ?></h3>
    </div>
    <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
      <div class="breadcrumb-wrapper col-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?= lang("Agreement Issuance", "Agreement Issuance") ?></li>
        </ol>
      </div>
    </div>
  </div>
                        ...
                        <div class="row">
                          <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="date" class="form-control pickadate required" data-value="<?= $po->po_date ?>" id="po_date" name="po_date">
                              </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="date" class="form-control pickadate required" data-value="<?= $po->delivery_date ?>" id="delivery_date" name="delivery_date">
                              </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div id="attachment-list">
                              ...
                              <div class="row">
                                <div class="col-md-2"><?php /* type */ ?>
                                  <?= $po_attachment_type[$m_purchase_order_attachment::TYPE_SIGNED_PO] ?>
                                </div>

                                <div class="col-md-1"><?php /* sequence */ ?> </div>

                                <div class="col-md-3">
                                  <input type="file" name="signed_po" class="required">
                                </div>

                                <div class="col-md-3"><?php /* upload time */ ?> </div>

                                <div class="col-md-3"><?php /* upload by */ ?> </div>
                              </div>
...
.pickadate('picker').set('select', new Date('<?= set_value('po_date_submit', $po->po_date) ?>'))

var delivery_date = $('#delivery_date').pickadate({
  format: 'd mmmm yyyy',
  formatSubmit: 'yyyy-mm-dd'
})
.pickadate('picker').set('select', new Date('<?= set_value('delivery_date_submit', $po->delivery_date) ?>'))
