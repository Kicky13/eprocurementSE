    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-1">
                <h3 class="content-header-title"><?= lang("Persetujuan Material", "Catalogue Number Request Approval") ?></h3>
            </div>
            <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?= lang("Persetujuan Material", "Catalogue Number Request Approval") ?></li>
                    </ol>
                </div>
            </div>
        </div>
              ...
              <div class="main1">
                <div class="card-header  bg-success bg-accent-4">
                  <div class="col-12 row">
                      <div class="col-8">
                          <h3 class="content-header-title mb-1">Catalogue Number Request</h3>
                      </div>
                      <div class="col-sm-8">
                  ...
                  <form class="form-horizontal m_registration_catalog" id="form" enctype="multipart/form-data">
                    ...
                    <div class="card-footer border-2 text-muted mt-2">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-2 col-form-label" style="text-align: right;">
                                <?= lang("Satuan Pembelian", "UOM Primary/Issue") ?>
                            </label>
                            <div class="col-md-4">
  ...
  $(document).ready(function() {
    ...
    $(document).on('show.bs.modal', '#modal_rej', function(e) {
      ...
      $('#reject_mdl').on('submit', function(e) {
        e.preventDefault();
        var data = new FormData(this);
        swalConfirm('Catalogue Number Request', '<?= __('confirm_reject') ?>', function() {
    ...
    var table=$('#tbl').DataTable({
        "ajax": {
            "url": "<?= base_url('material/Mregist_approval/datatable_logistic_specialist') ?>",
            "dataSrc": ""
        },
        "scrollX": true,
        "data": null,
