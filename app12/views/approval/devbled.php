...
<div class="app-content content">
    ...
    <div class="col-md-4">
                    ...
                    <form action="#" class="wizard-circle frm-bled" id="frm-bled">
                      ...
                      <fieldset>
                        ...
                        <div class="form-group text-right">
                          <a href="javascript:void(0)" class="btn btn-primary" role="button" onclick="addClick()">Add</a>
                        </div>
            <div class="row">
              <div class="col-sm-2">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="row">
                              ...
                              <input onkeyup="subjectKeyup()" class="form-control" name="subject" id="subject" value="<?= isset($ed->subject) ? $ed->subject : $msr->title?>">
                              </div>
                              <div class="col-md-12">
                                <div class="row">
                                  <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="bid_bond_type" id="bid_bond_type" onchange="bid_bond_type_change()">
                      ...
                      <fieldset>
                        <div class="row">
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td class="text-center">
                                      <a href="#" class="btn btn-primary btn-sm" onclick="copyClick(<?=$tmbi->line_item?>)">Copy</a>
                                    </td>
                                  </tr>
                                <?php endforeach;?>
                              </tbody>
                          ...
                          <div class="col-md-12" style="margin-top: 10px">
                            <label style="font-weight: bold;" class="pull-left">SOP List Item</label>
                            <a href="#" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalsop" onclick="addSopClick()">Add New Item</a>
                          </div>
                          <div class="col-md-12" style="margin-top: 10px">
                            <div class="table-responsive">
                              <table class="table table-condensed table-no-wrap sop_grid">
                      ...
                      <fieldset>
                        <div class="row">
                          <div class="col-md-12" style="margin-bottom: 10px">
                            <a href="#" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal">Upload File</a>
                          </div>
                          <div class="col-md-12">
                            <div class="table-responsive">
                              <table class="table table-condensed">
      ...
      <div class="content-footer" style="margin-top: 0em;margin-bottom: 2em">
              ...
              <div class="modal-body">
                <form method="post" class="form-horizontal" id="frm-assign-reject">
                  ...
                  <div class="form-group">
                    <div class="col-sm-12">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                      <button type="button" class="btn btn-primary" onclick="assignReject()">Save changes</button>
                    </div>
                  </div>
                </form>
              </div>
              ...
              <div class="modal-body row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                        <input class="form-control" name="qty2" id="qty2" required/>
                      </div>
                      <div class="col-sm-6">
        ...
        <?php if(@$approval->role_id == 8): ?>
          ...
          <a href="#" class="btn btn-success" data-toggle="modal" data-target="#modal-approve-assign">APPROVE/REJECT</a>
          <?php endif;?>
        <?php endif;?>
  ...
  <div class="modal fade" id="modal-validation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Validation Checklist</h4>
        </div>
        <div class="modal-body">
  ...
  <script type="text/javascript">
    ...
    function saveDraftBl() {
      ...
      $.ajax({
        ...
        success:function(r){
          stop($('#icon-tabs'));
          // alert(r);
          swal('Done','<?= __('success_submit') ?>','success')
          checkSubmit();
        }
      });
    }
    ...
    function hapusFile(argument) {
      ...
      {*/
      swalConfirm('Delete File', '<?= __('confirm_delete') ?>', function() {
        $.ajax({
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      function sop_type() {
        var r = $("#sop_type").val();
        if(r == '1') {
          $("#qty2,#uom2").attr("disabled", true);
        } else {
          $("#qty2,#uom2").attr("disabled", false);
        }
      }
      sop_type();
      ...
      $("#form-sop").submit(function(e) {
        ...
        if (check) {
          ...
          swal('<?= __('warning') ?>','There are empty input!','warning')
        }
      });
    });
    ...
    function deleteSopClick(id) {
      swalConfirm('SOP Delete', '<?= __('confirm_delete') ?>', function() {
        $.ajax({
          beforeSend:function(){
            start($('#icon-tabs'));
          },
  ...
  $('#item-inventory_type').change(function() {
    if ($(this).val() == 1) {
      // $('#item-cost_center').prop('disabled', true);
      $('#item-account_subsidiary').prop('required', false);
      $('#item-account_subsidiary').prop('disabled', true);
    } else {
      // $('#item-cost_center').prop('disabled', false);
      $('#item-account_subsidiary').prop('required', true);
        ...
        if ($('#bid_bond_type').val() == 1) {
          $('#bid_bond').keyup(function() {
              if ($('#bid_bond_type').val() == 1) {
                ...
                // $('#bid_bond').val(value);
                $('#bid_bond').replaceWith('<input placeholder="Fill bid here" class="form-control" id="bid_bond"  name="bid_bond" value='+value+'>');
              }
          });
          $('#bid_bond_validity').prop('readonly', false);
        } else {
