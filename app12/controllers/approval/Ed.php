...
class Ed extends CI_Controller {
    ...
    public function sendingMail($content) {
...
//                $sql = "INSERT INTO `i_notification` (`recipient`, `subject`, `content`, `ismailed`) VALUES ('supplier.supreme0028@gmail.com', 'Notification for Review dan Approval of Technical Evaluation', ' <p><p>\r\n                        <br><p>Greetings,<br />\r\n<br />\r\nPlease review and approve Technical Evaluation of MSR no.: no_msr.<br />\r\n&nbsp;</p>\r\n\r\n                        <br>\r\n                        <p>Thank you,<br />\r\nSupreme Energy - SCM Portal</p>\r\n\r\n<p>Note: This email is generated by system, do not reply.<br />\r\nPlease login to SCM Portal through Supreme Energy Intranet using Firefox or Chrome browser.</p>\r\n\r\n                        <br>\r\n                        ', 0)";
                $sql = "INSERT INTO i_notification (recipient, subject, content, ismailed) VALUES ('" . $data_email['recipient'] . "', '" . $data_email['subject'] . "', '" . $data_email['content'] . "', '" . $data_email['ismailed'] . "')";
                $query = $this->db->query($sql);

                // $z = $this->db->insert('i_notification', $data_email);
