    ...
    <div class="form-group row amendment_recommendation_tab">
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-5"><input class="form-control" <?= $ro1 ?> name="new_date_1" id="new_date_1" value="<?= isset($edit) ? $recom->new_date_1 : $newDate1Now ?>" ></div>
                <div class="col-md-5"><input class="form-control" <?= $ro1 ?> name="remarks_1" id="remarks_1" value="<?= $remarks_1 ?>" ></div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-5"><input class="form-control" <?= $ro2 ?> name="new_date_2" id="new_date_2" value="<?= isset($edit) ? $recom->new_date_2 : $newDate2Now ?>" ></div>
                <div class="col-md-5"><input class="form-control" <?= $ro2 ?> name="remarks_2" id="remarks_2" value="<?= $remarks_2 ?>" ></div>
            </div>
        </div>
    </div>
    <?php if(isset($issued)):?>
