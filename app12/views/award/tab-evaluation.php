    ...
    <div class="col-md-12">
	  <nav>
          ...
          <?php if($contract_review->num_rows() > 0): ?>
              <a class="nav-item nav-link active" id="nav-contract-review-tab" data-toggle="tab" href="#tab-contract-review" role="tab" aria-controls="nav-contact" aria-selected="false">BOD Contract Review</a>
          <?php endif;?>
		  	<?php else:?>
	  ...
	  <div class="tab-content" id="nav-tabContent">
	  	<?php if($bod) : ?>
	  		<?php if($contract_review->num_rows() > 0): ?>
	          <div class="tab-pane fade show active" id="tab-contract-review" role="tabpanel" aria-labelledby="contract-review-tab" style="padding: 15px 0px;">
	              <div class="row">
	                  <div class="col-md-12">
	                      <table class="table">
	                          <thead>
